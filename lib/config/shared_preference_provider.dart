...
class Prefs extends ChangeNotifier {
  ...
  static const String _enabledAiToolsMigrationKey =
      'enabledAiToolsWorkspaceOverviewMigrationV1';
  static const String _workspaceOverviewAiToolId = 'workspace_overview';
  ...
  List<String> get enabledAiToolIds {
    ...
    if (stored == null) {
      prefs.setBool(_enabledAiToolsMigrationKey, true);
    ...
    if (prefs.getBool(_enabledAiToolsMigrationKey) != true) {
      if (!stored.contains(_workspaceOverviewAiToolId)) {
        prefs.setStringList(
          _enabledAiToolsKey,
          [...stored, _workspaceOverviewAiToolId],
        );
      }
      prefs.setBool(_enabledAiToolsMigrationKey, true);
      return AiToolRegistry.sanitizeIds([
        ...stored,
        if (!stored.contains(_workspaceOverviewAiToolId))
          _workspaceOverviewAiToolId,
      ]);
    }
