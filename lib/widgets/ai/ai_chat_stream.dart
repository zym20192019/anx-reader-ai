...
class AiChatStreamState extends ConsumerState<AiChatStream> {
  ...
  List<Map<String, String>> _getQuickPrompts(BuildContext context) {
    if (widget.workspaceMode) {
      return [
        {
          'label': L10n.of(context).aiWorkspacePrompt1,
          'prompt': L10n.of(context).aiWorkspacePrompt1Text,
        },
        {
          'label': L10n.of(context).aiWorkspacePrompt2,
          'prompt': L10n.of(context).aiWorkspacePrompt2Text,
        },
        {
          'label': L10n.of(context).aiWorkspacePrompt3,
          'prompt': L10n.of(context).aiWorkspacePrompt3Text,
        },
      ];
    }
  ...
  void initState() {
    ...
    _starterPrompts = widget.workspaceMode
        ? [
            l10n.aiWorkspacePrompt1Text,
            l10n.aiWorkspacePrompt2Text,
            l10n.aiWorkspacePrompt3Text,
          ]
        : [
            l10n.quickPrompt1,
            l10n.quickPrompt2,
      ...
      appBar: AppBar(
        title: Text(
          widget.workspaceMode
              ? L10n.of(context).aiWorkspaceTitle
